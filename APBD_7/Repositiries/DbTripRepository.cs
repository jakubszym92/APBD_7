...
namespace APBD_7.Repositiries
{
    public class DbTripRepository : IDbTripRepository
    {
        ...
        public async Task AddTripToClientAsync(int idTrip, AddTripToClientRequestDto dto)
        {
            ...
            if (!TripExists) throw new Exception($"Trip: {idTrip} does not exist!");
            ...
            if (isClientAlreadyReservedThisTrip) throw new Exception("This trip is already reserved by this client!");
        ...
        public async Task<IEnumerable<GetTripsResponseDto>> GetTripsAsync()
        {
            ...
            if (!trips.Any()) throw new Exception("No data!");
